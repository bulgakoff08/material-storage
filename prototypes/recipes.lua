...
data:extend({
    ...
    recipe("crafting", 1, "ms-crafting-card-sb-solid-fuel-from-wax", items("solid-fuel", 100, "assembling-machine-1", 1, "ms-material-crystal-charged", 1), items("ms-crafting-card-sb-solid-fuel-from-wax", 1)),
