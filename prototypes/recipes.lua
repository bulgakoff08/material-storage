...
local templates = {
    ...
    ["ms-crafting-card-assembling-machine-1"] = {card = "ms-blank-crafting-card-t1", itemId = "assembling-machine-1"},
    ["ms-crafting-card-assembling-machine-2"] = {card = "ms-blank-crafting-card-t1", itemId = "assembling-machine-2"},
    ["ms-crafting-card-automation-science-pack"] = {card = "ms-blank-crafting-card-t1", itemId = "automation-science-pack"},
    ["ms-crafting-card-copper-cable"] = {card = "ms-blank-crafting-card-t1", itemId = "copper-cable"},
    ["ms-crafting-card-electronic-circuit"] = {card = "ms-blank-crafting-card-t1", itemId = "electronic-circuit"},
    ...
    ["ms-crafting-card-iron-chest"] = {card = "ms-blank-crafting-card-t1", itemId = "iron-chest"},
    ["ms-crafting-card-iron-gear-wheel"] = {card = "ms-blank-crafting-card-t1", itemId = "iron-gear-wheel"},
    ["ms-crafting-card-iron-stick"] = {card = "ms-blank-crafting-card-t1", itemId = "iron-stick"},
    ["ms-crafting-card-logistic-science-pack"] = {card = "ms-blank-crafting-card-t1", itemId = "logistic-science-pack"},
    ["ms-crafting-card-long-handed-inserter"] = {card = "ms-blank-crafting-card-t1", itemId = "long-handed-inserter"},
    ["ms-crafting-card-medium-electric-pole"] = {card = "ms-blank-crafting-card-t1", itemId = "medium-electric-pole"},
    ["ms-crafting-card-pipe"] = {card = "ms-blank-crafting-card-t1", itemId = "pipe"},
    ["ms-crafting-card-pipe-to-ground"] = {card = "ms-blank-crafting-card-t1", itemId = "pipe-to-ground"},
    ["ms-crafting-card-rail"] = {card = "ms-blank-crafting-card-t1", itemId = "rail"},
    ["ms-crafting-card-small-lamp"] = {card = "ms-blank-crafting-card-t1", itemId = "small-lamp"},
    ["ms-crafting-card-splitter"] = {card = "ms-blank-crafting-card-t1", itemId = "splitter"},
    ["ms-crafting-card-stack-inserter"] = {card = "ms-blank-crafting-card-t1", itemId = "stack-inserter"},
    ["ms-crafting-card-stone-wall"] = {card = "ms-blank-crafting-card-t1", itemId = "stone-wall"},
    ["ms-crafting-card-transport-belt"] = {card = "ms-blank-crafting-card-t1", itemId = "transport-belt"},
    ["ms-crafting-card-underground-belt"] = {card = "ms-blank-crafting-card-t1", itemId = "underground-belt"},

    ["ms-crafting-card-advanced-circuit"] = {card = "ms-blank-crafting-card-t2", itemId = "advanced-circuit"},
    ["ms-crafting-card-chemical-science-pack"] = {card = "ms-blank-crafting-card-t2", itemId = "chemical-science-pack"},
    ["ms-crafting-card-electric-furnace"] = {card = "ms-blank-crafting-card-t2", itemId = "electric-furnace"},
    ["ms-crafting-card-engine-unit"] = {card = "ms-blank-crafting-card-t2", itemId = "engine-unit"},
    ["ms-crafting-card-express-splitter"] = {card = "ms-blank-crafting-card-t2", itemId = "express-splitter"},
    ["ms-crafting-card-express-transport-belt"] = {card = "ms-blank-crafting-card-t2", itemId = "express-transport-belt"},
    ["ms-crafting-card-express-underground-belt"] = {card = "ms-blank-crafting-card-t2", itemId = "express-underground-belt"},
    ["ms-crafting-card-grenade"] = {card = "ms-blank-crafting-card-t2", itemId = "grenade"},
    ["ms-crafting-card-military-science-pack"] = {card = "ms-blank-crafting-card-t2", itemId = "military-science-pack"},
    ["ms-crafting-card-piercing-rounds-magazine"] = {card = "ms-blank-crafting-card-t2", itemId = "piercing-rounds-magazine"},
    ["ms-crafting-card-productivity-module"] = {card = "ms-blank-crafting-card-t2", itemId = "productivity-module"},
    ["ms-crafting-card-speed-module"] = {card = "ms-blank-crafting-card-t2", itemId = "speed-module"},
    ["ms-crafting-card-steel-chest"] = {card = "ms-blank-crafting-card-t2", itemId = "steel-chest"},

    ["ms-crafting-card-assembling-machine-3"] = {card = "ms-blank-crafting-card-t3", itemId = "assembling-machine-3"},
    ["ms-crafting-card-electric-engine-unit"] = {card = "ms-blank-crafting-card-t3", itemId = "electric-engine-unit"},
    ["ms-crafting-card-flying-robot-frame"] = {card = "ms-blank-crafting-card-t3", itemId = "flying-robot-frame"},
    ["ms-crafting-card-low-density-structure"] = {card = "ms-blank-crafting-card-t3", itemId = "low-density-structure"},
    ["ms-crafting-card-processing-unit"] = {card = "ms-blank-crafting-card-t3", itemId = "processing-unit"},
    ["ms-crafting-card-production-science-pack"] = {card = "ms-blank-crafting-card-t3", itemId = "production-science-pack"},
    ["ms-crafting-card-rocket-control-unit"] = {card = "ms-blank-crafting-card-t3", itemId = "rocket-control-unit"},
    ["ms-crafting-card-rocket-fuel"] = {card = "ms-blank-crafting-card-t3", itemId = "rocket-fuel"},
    ["ms-crafting-card-utility-science-pack"] = {card = "ms-blank-crafting-card-t3", itemId = "utility-science-pack"},
...
data:extend({
    ...
    recipe("crafting", 1, "ms-blank-crafting-card-t1", items("assembling-machine-1", 1, "ms-material-crystal-charged", 1), items("ms-blank-crafting-card-t1", 1)),
    recipe("crafting", 1, "ms-blank-crafting-card-t2", items("assembling-machine-2", 1, "ms-material-crystal-charged", 1), items("ms-blank-crafting-card-t2", 1)),
    recipe("crafting", 1, "ms-blank-crafting-card-t3", items("assembling-machine-3", 1, "ms-material-crystal-charged", 1), items("ms-blank-crafting-card-t3", 1)),
